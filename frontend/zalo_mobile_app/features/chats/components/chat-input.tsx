...
import { View, TextInput, TouchableOpacity, ActivityIndicator, Text, Platform, Keyboard, Modal, FlatList } from 'react-native';
                                ...
                                ListEmptyComponent={
                                    <View className="py-8 items-center">
                                        <Text className="text-onSurfaceVariant">
                                            {namecardSearch.trim() ? 'Không tìm thấy bạn bè phù hợp' : 'Bạn chưa có bạn bè để gửi namecard'}
                                        </Text>
                                    </View>
                                }
                            />
            ...
            >
                <View className="flex-1 bg-black/30 justify-end">
                    <View className="bg-card rounded-t-3xl px-4 pt-4 pb-6 max-h-[80%]">
                        ...
                        <TouchableOpacity className="bg-primary rounded-xl py-3 items-center mb-3" onPress={handleSaveQuickMessage}>
